...
Use the ‚zonal statistics’ tool calculate the New Delhi's population in 2018 and 2019. Select only the 'sum' statistics, which will give us the population, as shown in :numref:`4.2.19`.
